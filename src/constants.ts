...
export const departmentData: ChartData<'doughnut'> = {
  ...
  datasets: [
    {
      data: [1, 2, 7, 7, 4, 0, 2, 2, 19, 4, 2, 2, 0, 1],
      backgroundColor: [
        "#be8096",
        "#f4b3ca",
        "#ff3e82",
...
export const WILL_ACT = [
  ...
  {
    title: "定例会（オンライン）",
    content: "WILLでは、週1回、現在は水曜日12:30～13:30にオンライン定例会を行っています。WILLメンバーで集まります。セットアップやWILLの学習でつまずいたところを相談したり雑談したり、学部や所属コースを越えた交流ができます。",
...
export const EVENTS = [
  {
    title: "新歓説明会・セットアップ",
    subTitle: "(オンライン)",
    content: "新歓期に開催する特別なオンライン説明会です！WILLの活動やビジョン、入会方法についてお話します！質問や相談なども受け付けているので、少しでも気になった方はぜひお申し込みください！説明会後、入部希望の方向けにセットアップサポート（120分前後）も行いますので、ぜひ予定を開けてご参加ください！",
    dateName: "説明会日程",
    date: [
      "2024/05/01(水) 16:45-18:00 PlayGround/WILL合同 ⇒ 終了しました！",
      "2024/05/09(木) 12:45-14:00 PlayGround/WILL合同",
      "2024/05/13(月) 12:45-14:00 PlayGround/WILL合同",
      "2024/05/23(木) 17:15-18:30 PlayGround/WILL合同",
      "2024/05/31(金) 17:15-18:30 PlayGround/WILL合同"
    ],
    formName: "新歓説明会フォーム",
  ...
  },
  {
    ...
    dateName: "ハンズオン日程",
    date: ["2024/04/04(木) 16:00-17:30 ⇒ 終了しました！", "2024/04/20(土) 10:00-11:30 ⇒ 終了しました！"],
  ...
  },
  {
    ...
    dateName: "ハンズオン日程",
    date: ["2024/04/07(日) 10:00-11:30 ⇒ 終了しました！", "2024/05/11(土) 10:00-11:30"],
