...
export const EVENTS = [
  {
    ...
    dateName: "説明会日程",
    date: [
      "2025/03/19(水) 10:00〜11:00　対面（早稲田キャンパス3号館予定）",
      "2025/03/24(月) 20:00〜21:00　オンライン（Zoom予定）",
      "2025/03/26(水) 13:00〜14:00　オンライン（Zoom予定）",
      "2025/04/04(金) 14:00〜15:00　オンライン（Zoom予定）",
      "2025/04/07(月) 14:00〜15:00　オンライン（Zoom予定）",
      "2025/04/09(水) 20:00〜21:00　オンライン（Zoom予定）"
    ],
    formName: "新歓説明会フォーム",
